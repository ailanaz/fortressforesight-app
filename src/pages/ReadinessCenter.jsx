...
const PREMADE_CHECKLISTS = [
  ...
  },
  {
    ...
    description: 'A common home-loss event. Build a custom version for your local storm season.',
    items: [
      'Secure outdoor furniture and loose items',
      'Review roof, flashing, and gutter condition',
      'Check backup lighting and battery supplies',
  ...
  },
  {
    ...
    description: 'A common loss driver in many areas. Create a custom list for your roof, siding, and vehicles.',
    items: [
      'Review roof covering and skylight vulnerability',
      'Plan covered parking or vehicle protection',
      'Protect windows and exterior fixtures where possible',
  ...
  },
  {
    ...
    description: 'One of the most common and costly risks. Build a custom list for your flood zone and drainage conditions.',
    items: [
      'Check flood zone and drainage around the home',
      'Identify low-entry points, vents, and basement exposure',
      'Plan document storage above likely water level',
      'Review evacuation routes and local flood alerts',
    ],
  },
  {
    ...
    description: 'A common threat in many regions. Create a custom list for vegetation, ember exposure, and evacuation needs.',
    items: [
      'Review defensible space around the home',
      'Trim overhanging branches and clear debris',
      'Check vents, eaves, and ember entry points',
      'Plan go-bag, routes, and local alert enrollment',
    ],
  },
  {
    ...
    description: 'A major risk in seismic areas. Make a custom list if your region has meaningful earthquake exposure.',
    items: [
      'Review retrofitting needs for older structures',
